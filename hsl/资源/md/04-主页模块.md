...
![image-20200714172602305](assets/image-20200714172602305.jpg)
...
提完掉原来最后的两个 class 样式 .user-avatar 和 .el-icon-caret-bottom
...
import { login, getUserInfo } from '@/api/user'
  ...
  async getUserInfo (store) {
    ...
    store.commit('setUserInfo', result) // 将整个的个人信息设置到用户的vuex数据中
