    ...
    <div class="app-container">
      <el-card>
        <el-breadcrumb separator="/" class="titInfo ">
          <el-breadcrumb-item :to="{ path: '/employees' }">首页</el-breadcrumb-item>
          <el-breadcrumb-item>
        ...
        <el-row type="flex" justify="end">
          <el-button v-print="'#printPage'">开始打印</el-button>
        </el-row>
        <div v-if="type === 'personal'" id="printPage">
